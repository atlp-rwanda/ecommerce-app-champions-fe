...
import { addReview } from '../../redux/actions/review.action';
...
const AddReviewForm = ({ productId, onReviewAdded }) => {
	...
	const handleSubmit = async (event) => {
		...
		try {
			...
			// Review added successfully, handle any further actions or UI updates
			onReviewAdded();
		} catch (error) {
			// Handle error if review addition fails
		}
	};

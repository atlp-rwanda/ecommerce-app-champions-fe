...
import { vendorSignUpFields } from '../constants/formFields';
...
const fieldState = {};
vendorSignUpFields.forEach((field) => (fieldState[field.id] = ''));
...
const VendorSignupPage = () => {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		dispatch(registerVendor(signupState));
	};
